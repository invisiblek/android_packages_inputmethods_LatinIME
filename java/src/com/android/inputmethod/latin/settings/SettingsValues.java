...
public class SettingsValues {
    ...
    public static boolean mGestureLibForceDisabled;
    ...
    public static boolean isGestureLibForceDisabled() {
        return mGestureLibForceDisabled;
    }

    private static boolean readGestureLibForceDisabled(Resources res) {
        return res.getBoolean(R.bool.config_enable_swipe_gestures);
    }
